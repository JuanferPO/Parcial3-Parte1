    ...
    <ion-content>
      <div id="login-container">
        <div id="login-form">
          ...
          <InputComponent type="number" id="categoriaId" name="categoriaId" label="Id de la categoria: " />
          <InputComponent type="number" id="usuarioId" name="usuarioId" label="Id del usuario: " />
        </div>
        <div>
